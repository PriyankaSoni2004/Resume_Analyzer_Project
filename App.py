...
# libraries used to parse the pdf file
...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Priyanka@2004',db='cv')

# # ElephantSQL connection parameters
# hostname = 'satao.db.elephantsql.com'
# database = 'attwghml'
# username = 'attwghml'
# password = 'gNDTiuTqJOG8otYp1QCZnMuwmiQa7CQs'
